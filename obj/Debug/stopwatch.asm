...
; This file was generated Thu Aug 08 11:48:38 2019
;--------------------------------------------------------
...
;; 	line = 6937 result AOP_REG=r0x1049, size=2, left -=-, size=0, right AOP_LIT=0x00, size=2
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1109 rIdx = r0x1049 
	.line	10; "stopwatch.c"	tWord cnt=0;
	BANKSEL	r0x1001
	CLRF	r0x1001
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
...
;; 	line = 6937 result AOP_DIR=_TRISB, size=1, left -=-, size=0, right AOP_LIT=0x00, size=1
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1009
;;	1028  _TRISB   offset=0
	.line	12; "stopwatch.c"	TRISB=0X00;
	BANKSEL	_TRISB
	CLRF	_TRISB
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6927:genAssign *{*
...
;; 	line = 6937 result AOP_DIR=_PORTB, size=1, left -=-, size=0, right AOP_LIT=0x00, size=1
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1009
;;	1028  _PORTB   offset=0
	.line	13; "stopwatch.c"	PORTB=0;
	BANKSEL	_PORTB
	CLRF	_PORTB
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2173:genCall
	.line	14; "stopwatch.c"	Timer_INIT();
	PAGESEL	_Timer_INIT
...
;;	_PORTBbits
;; 	line = 6523 result AOP_PCODE=_PORTBbits, size=2, left -=-, size=0, right AOP_LIT=0x00, size=1
...
_00110_DS_
	.line	19; "stopwatch.c"	if(run_flag){
	MOVLW	0x00
...
;;	694 register type nRegs=2
;;	575
;; 	line = 618 result AOP_REG=r0x1049, size=2, left AOP_REG=r0x1049, size=2, right AOP_LIT=0x05, size=2
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:344:genAddLit
	.line	21; "stopwatch.c"	cnt+=Timer_Tick_ms;
	MOVLW	0x05
...
;; ifx is non-null
;;	694 register type nRegs=2
;; 	line = 3631 result AOP_CRY=0x00, size=0, left AOP_REG=r0x1049, size=2, right AOP_LIT=0xd0, size=2
;; ***	mov2w  1381  offset=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1386:mov2w
;;	1109 rIdx = r0x1049 
	.line	23; "stopwatch.c"	if(cnt==2000){
	MOVF	r0x1001,W
...
;;	833: aopGet AOP_PCODE type PO_IMMEDIATE
;;	_PORTBbits
;; 	line = 6523 result AOP_PCODE=_PORTBbits, size=2, left -=-, size=0, right AOP_REG=r0x104C, size=1
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:6249:genPackBits *{*
;; ***	genPackBits  6250
...
;; ***	aopForSym 315
;;	327 sym->rname = _run_flag, size = 1
;; 	line = 6937 result AOP_DIR=_run_flag, size=1, left -=-, size=0, right AOP_LIT=0x00, size=1
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
;;	1009
;;	1028  _run_flag   offset=0
_00108_DS_
	.line	28; "stopwatch.c"	run_flag=0;
	BANKSEL	_run_flag
	CLRF	_run_flag
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;	   45+   17 =    62 instructions (  158 byte)
